...
const Chader = ({price, img}) => {
  return (
    <div className='m-5 w-70 bg-blue-900 border-red-100 border-2 rounded-2xl p-5 flex flex-col justify-between items-center'>
      ...
      <h2 className='text-white font-bold capital flex justify-center'>Scarf</h2>
      ...
      <div className='text-white mt-3 flex justify-between'>
        <button className='bg-gray-900 font-bold pl-2 pr-2 rounded-full'>Buy Now</button>
