...
const Home = () => {
  return (
    <div className="flex justify-evenly flex-wrap align-center bg-white h-full w-full mt-10">
    ...
    <div className='mt-10'>
      <img className='w-100' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQwwbwkXXbsZoXxKwyjqRgOCD5GBCt_YuPeIw&s" alt="hero" />
    </div>
   </div>
  )
}
